...
<?php
   ...
   //NOMBRE CONTENEDOR
    ...
    $Mes = date("m");  
    $tamaniocampo="-lg";
    $estado_dato=mysqli_query($con, "SELECT * FROM estado_dato");
                    ...
                    <div class="">
                        <div class="page-title">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <?php
                                include("modal/mantenimiento_productos.php");
                                ?>
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-12 col-sm-12 col-xs-12 form-group"> 
                                                    ...
                                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                                        <input type="text" class="form-control" id="q" name="q" placeholder="Nombre Producto" ><!--//onkeyup='load(1);'-->
                                                    </div>
...
<script>
    ...
    var parametros = $(this).serialize();
        $.ajax({
                type: "POST",
                url: "action/mantenimiento_productos.php",
                data: parametros,
    ...
    event.preventDefault();
       ...
       function limpiarFormulario() {
        ...
        $('#estado_producto').val(1).addClass("selectpicker").selectpicker('refresh');         
        $("#result").hide(); 
        }
...
<script language="javascript">
            ...
            function obtener_datos(id){
                var titulo = '<?=$titulo?>';
                document.getElementById('myModalLabel').innerHTML= '<strong><i class="fa fa-plus-circle" aria-hidden="true"></i> Editar '+titulo+'</strong>';
                        ...
                        $("#estado_producto").val(idestado_dato).addClass("selectpicker").selectpicker('refresh'); 
