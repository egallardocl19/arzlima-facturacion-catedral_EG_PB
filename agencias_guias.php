...
<?php
   ...
   //NOMBRE CONTENEDOR
    ...
    $nombre_agencia=mysqli_query($con, "SELECT * FROM agencia where idestado_dato=1");
                ...
                <div class="clearfix"></div>
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <?php
                            ...
                            include("modal/mantenimiento_agencias_guias.php");
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-12 col-sm-12 col-xs-12 form-group"> 
                                                    ...
                                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                                        <input type="text" class="form-control" id="q" name="q" placeholder="Dni - Nombres - Agencia" ><!--//onkeyup='load(1);'-->
                                                    </div>
...
<script type="text/javascript" src="js/agencias_guias.js"></script>
...
<script>
    ...
    var parametros = $(this).serialize();
        $.ajax({
                type: "POST",
                url: "action/mantenimiento_agencias_guias.php",
                data: parametros,
