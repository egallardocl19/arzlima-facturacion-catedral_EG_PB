...
?> 
    ...
    <div class="modal fade bs-example-modal-lg-registroconcarrat" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content"> 
                ...
                <div class="modal-body">
                    <form class="form-horizontal form-label-left input_mask" method="post" id="addregistroconcar_admin" name="addregistroconcar_admin" ><!--target="_blank"-->
                        <div id="resultreporteadmin"></div>
