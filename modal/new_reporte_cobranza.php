<?php
    ...
    $rutalocal='../syscatedral/report/reporte_cobranza.php';
    $rutalocal2='../syscatedral/report/reporte_cobranza_excel.php';
    $rutaserver='../report/reporte_cobranza.php';
    $rutaserver2='../report/reporte_cobranza_excel.php';
?> 

   
    <div class="modal fade bs-example-modal-lg-reportecobranza" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-mg">
            <div class="modal-content"> 
                <div class="modal-header bg-<?php echo $colorheder ?> text-white" >
                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span>
                    </button>
                    <h4 class="modal-title" id="myModalLabel" style="text-align: center"><strong><i class="fa fa-book" aria-hidden="true"></i> Reporte Cobranza</strong></h4>
                </div>
                <div class="modal-body">
                    <form class="form-horizontal form-label-left input_mask" method="post" id="addreporte_propi" name="addreporte_propi" target="_blank">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12"><i class="fa fa-tag" aria-hidden="true"></i> N° Cobranza: <span class="required"></span></label>
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                <select class="form-control selectpicker" data-show-subtext="true" data-live-search="true" id="cobranza" name="cobranza" data-size="5" style="max-width: 100%!important;" >
                                <option value="">--Seleccione Cobranza--</option>  
                                <?php foreach($cobranza as $p):?>
                                        <option value="<?php echo $p['n_cobranza']; ?>"><?php echo $p['n_cobranza']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <button class="btn btn-success" name="export3" formaction="<?php echo $rutaserver2 ?>"><span class="fa fa-file-excel-o"></span> Exportar a Excel</button>
