                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">  
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                                <label class="control-label col-md-4 col-sm-4 col-xs-12"><i class="fa fa-barcode" aria-hidden="true"></i> DNI: <span class="required"></span></label>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                ...
                                <input type="text"  id="nombre" name="nombre" class="form-control"  placeholder="Nombres" maxlength="200" onkeyup="javascript:this.value=this.value.toUpperCase();">
                                </div>

                            </div> <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                <label class="control-label col-md-2 col-sm-2 col-xs-12"><i class="fa fa-university" aria-hidden="true"></i> Apellido: <span class="required"></span></label>
                                <div class="col-md-10 col-sm-10 col-xs-12">
                                <input type="text"  id="apellido" name="apellido" class="form-control"  placeholder="Apellidos" maxlength="200" onkeyup="javascript:this.value=this.value.toUpperCase();">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                <label class="control-label col-md-2 col-sm-2 col-xs-12"><i class="fa fa-tag" aria-hidden="true"></i> Agencia:</label>
