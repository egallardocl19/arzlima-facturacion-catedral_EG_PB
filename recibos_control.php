                ...
                <div class="clearfix"></div>
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <?php
                            ...
                            include("modal/mantenimiento_recibos_control.php");
...
<script language="javascript">
            ...
            var titulo = '<?=$titulo?>';
            document.getElementById('myModalLabel').innerHTML= '<strong><i class="fa fa-plus-circle" aria-hidden="true"></i>'+titulo+'</strong>';
