        ...
        if ($numrows>0){
            ...
            <table class="table table-striped jambo_table bulk_action">
                ...
                ?>
                    ...
                    <input type="hidden" value="<?php echo $idagencia;?>" id="idagencia<?php echo $id;?>">
                    ...
                    <tr class="even pointer">
                        ...
                        <a href="#" class='btn btn-info' title='Editar Guia' onclick="obtener_datos('<?php echo $id;?>');" data-toggle="modal" data-target=".bs-example-modal-lg-add"><i class="glyphicon glyphicon-edit"></i></a> 
