...
<?php
    ...
    if($action == 'ajax'){
        ...
        $q = mysqli_real_escape_string($con,(strip_tags($_REQUEST['q'], ENT_QUOTES)));
         ...
         $sTable = "ticket t, tipos_ticket tt, tipo_moneda tm";
         $sWhere = "WHERE t.idtipo_ticket=tt.id and tt.idtipo_moneda=tm.id and t.serie in(select abrev from recibos_serial where idsubmodulo=$submod) ";
        if ( $_GET['q'] != "" ) 
        {
            $sWhere = "WHERE t.idtipo_ticket=tt.id and tt.idtipo_moneda=tm.id and t.serie in(select abrev from recibos_serial where idsubmodulo=$submod)  and  (";
        ...
        $sql="SELECT t.id,t.serie,t.numero,t.fecha,t.dni,tt.nombre,tm.signo,format(t.monto_total,2) as importe,
            ...
            <table class="table table-striped jambo_table bulk_action">
                <thead>
                    <tr class="headings">
                        ...
                        <th class="column-title">Fecha Compra </th>
