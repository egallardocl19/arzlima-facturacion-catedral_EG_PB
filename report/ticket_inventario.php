...
function Header()
{
    ...
    //$this->Image('../images/profiles/fondo.png', 0, 0, 0, 255);
    $this->Image('../images/profiles/logo4.png',1,1,25);
    // Arial bold 15
	...
	// Salto de línea
    //$this->Ln(1);
    $this->Cell(72,0,'MUSEO DE ARTE',0,1,'C');
     $this->Ln(5);
    $this->Cell(72,0,'RELIGIOSO',0,1,'C');
	//$this->SetFont('Arial','B',8);
    $this->Cell(45,6,utf8_decode(''),0,1,'C',0);
...
$pdf = new PDF('L', 'mm', array(29,90)); //DIMENSION BOLETA
$pdf -> AliasNbPages();
$pdf->AddPage();
...
$pdf->Cell(45,6,utf8_decode(' Nº INVEN: '.$serie."-".$numero),0,1,'C',0);
//$pdf->Cell(40,6,$serie."-".$numero,1,1,'C',0);
...
$pdf->Image('resultado.png', 66, 3, 25, 25);
