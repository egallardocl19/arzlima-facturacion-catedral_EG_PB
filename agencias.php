                ...
                <div class="clearfix"></div>
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <?php
                            ...
                            include("modal/mantenimiento_agencias.php");
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-12 col-sm-12 col-xs-12 form-group"> 
                                                    ...
                                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                                        <input type="text" class="form-control" id="q" name="q" placeholder="Ruc - Razón Social" ><!--//onkeyup='load(1);'-->
                                                    </div>
...
<script type="text/javascript" src="js/agencias.js"></script>
...
<script>
    ...
    var parametros = $(this).serialize();
        $.ajax({
                type: "POST",
                url: "action/mantenimiento_agencias.php",
                data: parametros,
